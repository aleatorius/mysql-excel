        ...
        for i in data:
            ...
            if str(i[2]) == 'Advanced':
                ...
                for j in ls:
                    ...
                    if str(j[2]) not in ['Lesson 15','Lesson 16','Lesson 17','Lesson 18', 'Lesson 19'] :
                        ...
                        for entry in level_3:          
                            folder_level_3 = folder_level_2+'/'+str(entry[2]).replace(":","_colon").replace("?","_qm_").replace('/','_backslash_').rstrip('\r\n').replace("\r\n ","").replace("+","_")
